...
console.log(
    (cities.slice(Math.floor(Math.random()*cities.length))).concat(
        (mountains.slice(Math.floor(Math.random()*mountains.length)))).concat(
            (countries.slice(Math.floor(Math.random()*countries.length)))).concat(
                (languages.slice(Math.floor(Math.random()*languages.length)))).concat(
                    (rivers.slice(Math.floor(Math.random()*rivers.length))))
